    ...
    <div class="service-details-grid">
      ...
      <aside class="service-sidebar">
        ...
        <div class="sidebar-links">
          ...
          <a href="https://www.casaurabhvanyasharma.com/international-tax" class="sidebar-link active">International Tax & Structuring</a>
      ...
      <div class="service-main-content">
        ...
        <p>
          At Saurabh Vanya Sharma & Co. (SVS), we assist multinational corporations, foreign subsidiaries, and domestic exporters in optimizing their global tax footprint, managing <a href="https://www.casaurabhvanyasharma.com/audit-assurance">transfer pricing audits</a>, and remaining fully compliant with RBI and FEMA guidelines. For entity incorporation and joint venture structuring, see our <a href="https://www.casaurabhvanyasharma.com/corporate-advisory">Business Consulting & Advisory</a> services.
        </p>
        ...
        <p>
          Capital inflows and outflows in India are strictly regulated by the Reserve Bank of India (RBI) under the Foreign Exchange Management Act (FEMA). SVS offers complete support for corporate clients receiving Foreign Direct Investment (FDI) or making Overseas Direct Investments (ODI), including entity registration, filing mandatory disclosure returns on FIRMS portal, and ensuring regular transaction-based reporting to avoid penalties. For domestic <a href="https://www.casaurabhvanyasharma.com/taxation">direct & indirect tax</a> compliance, visit our Taxation page. We also provide <a href="https://www.casaurabhvanyasharma.com/accounting-advisory">accounting & GAAP advisory</a> to ensure your global books are consistent, and <a href="https://www.casaurabhvanyasharma.com/bpo-outsourcing">BPO services</a> for streamlined finance functions.
        </p>
